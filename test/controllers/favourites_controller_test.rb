...
class FavouritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favourite" do
    assert_difference('Favourite.count') do
      post favourites_url, params: { favourite: { name: @favourite.name, person: @favourite.person, preview_url: @favourite.preview_url, spotify_id: @favourite.spotify_id } }
    end
  ...
  test "should update favourite" do
    patch favourite_url(@favourite), params: { favourite: { name: @favourite.name, person: @favourite.person, preview_url: @favourite.preview_url, spotify_id: @favourite.spotify_id } }
